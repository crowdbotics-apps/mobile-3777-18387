"""mobile_3777_18387 URL Configuration
...
admin.site.site_header = "mobile 3777"
admin.site.site_title = "mobile 3777 Admin Portal"
admin.site.index_title = "mobile 3777 Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="mobile 3777 API",
        default_version="v1",
        description="API documentation for mobile 3777 App",
    ),
    public=True,
